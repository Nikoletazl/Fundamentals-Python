...
def max_num_criteria(collection: list, custom_filter):
    man_element = float("-inf")
    max_element_index = -1
...
def min_num_criteria(collection, custom_filter):
...
def first_count_elements_criteria(collection: list, count: int, custom_filter):
...
def last_count_elements_criteria(collection: list, count: int, custom_filter):
    if count > len(collection):
        print("Invalid count")
    else:
        matching_elements = []
...
while command != "end":
    ...
    if cmd_type == "exchange":
        ...
        if cmd_filter == "even":
            max_index = max_num_criteria(numbers, lambda n: n % 2 == 0)
        elif cmd_filter == "odd":
            max_index = max_num_criteria(numbers, lambda n: n % 2 != 0)
        ...
        if cmd_filter == "even":
            min_index = min_num_criteria(numbers, lambda n: n % 2 == 0)
        elif cmd_filter == "odd":
            min_index = min_num_criteria(numbers, lambda n: n % 2 != 0)
        ...
        if cmd_filter == "even":
            first_count_elements_criteria(numbers, count, lambda n: n % 2 == 0)
        elif cmd_filter == "odd":
            first_count_elements_criteria(numbers, count, lambda n: n % 2 == 0)
    elif cmd_type == "last":
        count = int(cmd_args[1])
        ...
        if cmd_filter == "even":
            last_count_elements_criteria(numbers, count, lambda n: n % 2 == 0)
        elif cmd_filter == "odd":
            last_count_elements_criteria(numbers, count, lambda n: n % 2 != 0)
